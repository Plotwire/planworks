...
//
// Once supabase/paywall-policies.sql is live, INSERT and UPDATE on projects and
// sketches require an active subscription at the database level. Postgres
...
export const SUBSCRIPTION_INACTIVE_MESSAGE =
  ...
  "Your drawings are safe — you can still open and export them.";
